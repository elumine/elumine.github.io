...
Work = (function() {
  ...
  Work.prototype.setVode = function(video) {
    this.video = video;
    return this;
  };
  ...
  Work.prototype.setImages = function(images) {
    var i, image, ref;
    this.images = [];
    for (image = i = 0, ref = images; 0 <= ref ? i <= ref : i >= ref; image = 0 <= ref ? ++i : --i) {
